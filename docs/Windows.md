...
A git binary is required, for example from [gitforwindows.org](https://gitforwindows.org/).

![gitforwindows](gitforwindows.png)
...
<img src="msdkstart.png" alt="msdkstart" style="zoom: 67%;" />
