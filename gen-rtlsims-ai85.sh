...
./cnn-gen.py --verbose --autogen rtlsim --top-level cnn -L --test-dir rtlsim --prefix ai85-fifostream-transition-early --config-file tests/test-stream-transition-early.yaml --ai85 --fifo --stop-after 5
