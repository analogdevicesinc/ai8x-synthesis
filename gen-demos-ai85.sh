...
./ai8xize.py -e --verbose --top-level cnn -L --test-dir demos --prefix ai85-mnist --checkpoint-file trained/ai84-mnist.pth.tar --config-file networks/mnist-chw-ai85.yaml --ai85
