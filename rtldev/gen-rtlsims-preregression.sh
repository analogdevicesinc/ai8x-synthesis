...
./ai8xize.py --rtl"$PRELOAD" --verbose --autogen $TARGET --autogen_list $AUTOGEN_LIST --log --test-dir $TARGET --prefix $PREFIX-fastfifostream-x4-readahead-nopad-multipass5-w8 --config-file tests/test-ffsx4readahead-nopad-multipass5-w8.yaml --fast-fifo --riscv --device "$DEVICE" --queue-name medium "$@"
