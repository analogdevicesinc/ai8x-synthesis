...
def load(dataset, _quantization):
    ...
    if dataset == 'test_conv1d':
        ...
        layers = 1
        w = np.array([[[[-87, -89, -76], [4, 77, 96], [-11, -78, 82]],
                       [[-96, -32, -91], [-46, -8, 8], [-10, -68, -86]],
                       [[-126, 90, 98], [60, -113, 14], [-42, 100, -90]],
                       [[-18, -52, -61], [109, 34, 81], [95, -98, 71]],
                       [[-51, 125, -62], [-86, -21, 62], [91, 5, -107]]],
                      [[[-78, 119, 44], [75, 50, -103], [-116, 21, -12]],
                       [[-103, -118, -102], [75, 82, 10], [23, 22, 5]],
                       [[-100, -124, 11], [110, -16, 74], [-112, 124, 61]],
                       [[88, -50, 39], [81, -1, 70], [-97, -20, -124]],
                       [[118, 115, 109], [-62, -34, -55], [93, -117, 99]]],
                      [[[-72, -98, 63], [34, -7, -39], [-24, -21, 12]],
                       [[104, 98, -128], [-54, -94, 18], [-79, -36, 76]],
                       [[-3, 77, -57], [-27, 80, 6], [85, -88, -60]],
                       [[-122, 33, 110], [2, 10, 61], [-55, 32, 113]],
                       [[-59, 53, -48], [-105, -43, 94], [104, 8, 109]]]],
                     dtype=np.int64)
        input_channels.append(w.shape[1])  # Input channels
        output_channels.append(w.shape[0])  # Output channels
        weights.append(w.reshape(-1, 3, 3))
        bias.append(None)
    else:
